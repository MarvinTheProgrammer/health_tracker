defmodule HealthTrackerWeb.ExerciseLiveTest do
  use HealthTrackerWeb.ConnCase

  import Phoenix.LiveViewTest
  import HealthTracker.ExercisesFixtures

  @create_attrs %{name: "some name", description: "some description", equipment: ["option1", "option2"], video_link: "some video_link"}
  ...
  @invalid_attrs %{name: nil, description: nil, equipment: [], video_link: nil}
